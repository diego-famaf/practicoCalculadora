...
// observacion: despues de renegar un monton y probar muchas cosas,y ver que ni firefox ni chrome me muestran por la pantalla de la calculadora el +,-,*,/ y . y tampoco evalua cuando se 
//utiliza desde teclado,decidi entregar este trabajo esperando recibir una respuesta de donde esta el problema y la solucion.
//observacion actualizada: si,era esa correccion profe,if(caracteres.includes(caracter)),ahora lo unico que por ahi falla es
//que despues de usar la calculadora con el mouse, y despues querer usarla con el teclado
//no evalua,pero se soluciona actualizando la pagina antes.